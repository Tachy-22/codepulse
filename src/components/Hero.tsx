...
export default function Hero() {
  ...
  return (
    <div className="lg:h-[80vh] h-[50vh] py-[1rem] lg:py-[5rem] w-full max-w-7xl bg-white dark:bg-black flex items-center justify-between   mx-auto gap-12 overflow-x-hidden ">
      <Image
        width={3000}
        height={3000}
        alt="img1"
